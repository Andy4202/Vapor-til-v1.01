...
extension Application {
    ...
    func sendRequest<T>(
        ...
        if (loggedInRequest || loggedInUser != nil) {
            ...
            //      Note: This requires you to know the user's password.
            //      As all the users in your test have the password "password", this isn't an issue.
            //      If no user is specified, use "admin"
